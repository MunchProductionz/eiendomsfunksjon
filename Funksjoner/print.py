    ...
    while svar_test == False:
        ...
        if svar == 1:
            ...
            for bolig in range(boligliste):
                ...
                endring_egenkapital_% = boligliste[bolig][4]
                endring_egenkapital_%_per_år = boligliste[bolig][5]

                print(f'Bolig {bolig}   |   EOC: {eoc} - Omløpsrate: {omløpsrate} - PROI: {proi}   |   Fortjeneste: {endring_egenkapital} - Fortjeneste %: {endring_egenkapital_%} - Fortjeneste % per år: {endring_egenkapital_%_per_år}')
        ...
        #Eiendom            -       Sorterer etter "vekst_eiendomsverdi_%"
        elif svar == 3:
            svar_test = True
            ...
            for bolig in range(boligliste):
                ...
                vekst_eiendomsverdi_% = boligliste[bolig][2]
                vekst_eiendomsverdi_%_per_år = boligliste[bolig][3]
                månedlige_renter = boligliste[bolig][4]
                total_renter_eiendom = boligliste[bolig][5]

                print(f'Bolig {bolig}   |   Kjøpsverdi: {eiendomsverdi}   |   Fortjeneste: {vekst_eiendomsverdi} - Fortjeneste %: {vekst_eiendomsverdi_%} - Fortjeneste % per år: {vekst_eiendomsverdi_%_per_år}   |   Månedlige renter: {månedlige_renter} - Totale renter: {total_renter_eiendom}')
